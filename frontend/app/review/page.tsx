...
function ApproveButton({ contentItemId }: { contentItemId: number }) {
  ...
  return (
    <form onSubmit={handleApprove} className="flex flex-wrap items-end gap-3 rounded-md border border-gray-200 bg-gray-50/50 px-4 py-3">
      <label className="block">
      ...
      <label className="block">
        <span className="mb-1 block text-xs font-semibold uppercase tracking-wide text-gray-500">Passcode</span>
        <input
          required
          type="password"
          value={passcode}
